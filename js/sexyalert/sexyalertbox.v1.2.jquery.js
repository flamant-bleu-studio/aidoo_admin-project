  ...
  Sexy = {
    ...
    messageBox: function(type, message, properties, input) {
        ...
        else if(type == 'radio')
        {
            ...
            $('#'+this.options.name+'-Buttons').append('<input id="BoxRadioBtnOk" type="submit" /> <input id="BoxRadioBtnCancel" type="submit" />');
            $('#BoxRadioBtnOk').val(properties.textBoxBtnOk);
            $('#BoxRadioBtnCancel').val(properties.textBoxBtnCancel);
			
            
			this.Content.prepend('<input id="BoxRadioInput2" type="radio" name="RadioInput" value="sexyradio2"/>'+properties.radioTextBox2+'<br/>');
			this.Content.prepend('<input id="BoxRadioInput1" type="radio" name="RadioInput" value="sexyradio1"/>'+properties.radioTextBox1+'<br/>');
			
			$('#BoxRadioBtnOk').attr("disabled", "true");
			
			$('#BoxRadioInput1').bind('click', $.bind(this, function(){
				$('#BoxRadioBtnOk').removeAttr("disabled");
				this.options.onReturn = $('#BoxRadioInput1').val();
            }));
			
			$('#BoxRadioInput2').bind('click', $.bind(this, function(){
				$('#BoxRadioBtnOk').removeAttr("disabled");
				this.options.onReturn = $('#BoxRadioInput2').val();
            }));
			
            $('#BoxRadioBtnOk').bind('click', $.bind(this, function(){
              this.display(0);
            }));

            $('#BoxRadioBtnCancel').bind('click', $.bind(this, function(){
              this.options.onReturn = false;
              this.display(0);
            }));

            this.Content.addClass('BoxRadio').prepend(message);
            this.display(1);
        }
        else if(type == 'radio3')
        {
            ...
            this.Content.prepend('<input id="BoxRadioInput3" type="radio" name="RadioInput" value="sexyradio3"/>'+properties.radioTextBox3+'<br/>');
			this.Content.prepend('<input id="BoxRadioInput2" type="radio" name="RadioInput" value="sexyradio2"/>'+properties.radioTextBox2+'<br/>');
			this.Content.prepend('<input id="BoxRadioInput1" type="radio" name="RadioInput" value="sexyradio1"/>'+properties.radioTextBox1+'<br/>');
			...
			$('#BoxRadioInput3').bind('click', $.bind(this, function(){
				$('#BoxRadioBtnOk').removeAttr("disabled");
				this.options.onReturn = $('#BoxRadioInput3').val();
            }));
        ...
        {
            $('#'+this.options.name+'-Buttons').append('<input id="BoxConfirmBtnCancel" type="submit" /><input id="BoxConfirmBtnNo" type="submit" /> <input id="BoxConfirmBtnYes" type="submit" />');
            $('#BoxConfirmBtnCancel').val(properties.textBoxBtnCancel);
            $('#BoxConfirmBtnNo').val(properties.textBoxBtnNo);
            $('#BoxConfirmBtnYes').val(properties.textBoxBtnYes);
            
            $('#BoxConfirmBtnYes').bind('click', $.bind(this, function(){
              this.options.onReturn = "yes";
              this.display(0);
            }));
            $('#BoxConfirmBtnNo').bind('click', $.bind(this, function(){
                this.options.onReturn = "no";
                this.display(0);
              }));
            $('#BoxConfirmBtnCancel').bind('click', $.bind(this, function(){
              this.options.onReturn = "cancel";
              this.display(0);
            }));
        ...
        else if(type == 'confirm')
        {
            ...
            $('#BoxConfirmBtnOk').val(properties.textBoxBtnOk);
            $('#BoxConfirmBtnCancel').val(properties.textBoxBtnCancel);
        ...
        else if(type == 'prompt')
        {
            ...
            $('#BoxPromptBtnOk').val(properties.textBoxBtnOk);
            $('#BoxPromptBtnCancel').val(properties.textBoxBtnCancel);
	...
	preloadImages: function() {
	  ...
	  img[0].src = this.Box.css('background-image').replace(new RegExp("url\\('?([^']*)'?\\)", 'gi'), "$1").replace(new RegExp("["+'"'+"]","g") ,'');
	  img[1].src = this.InBox.css('background-image').replace(new RegExp("url\\('?([^']*)'?\\)", 'gi'), "$1").replace(new RegExp("["+'"'+"]","g") ,'');
	  img[2].src = this.Contenedor.css('background-image').replace(new RegExp("url\\('?([^']*)'?\\)", 'gi'), "$1").replace(new RegExp("["+'"'+"]","g") ,'');
	},
    ...
    */
    ...
    Argument:
      properties - see Options in messageBox
    */
    radio: function(message, properties){
      this.messageBox('radio', message, properties);
    },
    radio3: function(message, properties){
      this.messageBox('radio3', message, properties);
    },
    /*
    Property: confirm
      Shortcut for confirm
    ...
    Argument:
      properties - see Options in messageBox
    */
    yesNoCancel: function(message, properties){
      this.messageBox('yesNoCancel', message, properties);
    },
